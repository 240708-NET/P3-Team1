...
INSERT INTO Courses ([name],[description],[category]) VALUES ('Infotainment Technology','Information is very important, probably. Like, we gotta know stuff to do stuff, and everyone wants to do stuff. Sometimes the things that I wanna do are deemed to be a "hazard to myself and others," which means I get put in the dumb-dumb zone again, but what they don''t know is that I hid a comic book over there so joke''s on them!','Physical Science');
